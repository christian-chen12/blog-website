...
# index route/home page, allows users to create posts which are added to the database
...
# this form allows users to follow other users (does not have own page, serves as a function on profile page)
...
# this form allows users to unfollow other users (does not have own page, serves as a function on profile page)
...
# takes user to page where they can request to change their password via email
...
# when user clicks on the password reset link they are taken to this page to reset it
